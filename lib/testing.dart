          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              isLinked
                  ...
                  : [AppColors.bgStart, AppColors.bgEnd],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ),
            border: Border.all(
              color: isLinked ? Colors.white54 : Colors.white24,
              width: 2,
            ),
            boxShadow: const [
              BoxShadow(
      ...
      children: [
        Row(
          children: [
            ...
            InkWell(
              onTap: () async {
                if (widget.macController.isBusy.value) return; // Prevent concurrent operations
                setState(() {
                  isLinking = true;
                });
                printFunc("data : ${widget.data}");
                await widget.macController.deleteTrackr(
                  "${widget.data["index"]}",
                );
                await Future.delayed(
                  Duration(seconds: widget.macController.interval - 3),
                );
      ...
      children: [
        ...
        SizedBox(
          ...
          isLinking
            ...
            valueListenable: widget.macController.isBusy,
            builder: (contextt, busy, _) {
              return OutlinedButton.icon(
                onPressed: busy ? (){} : () async {
                  ...
                  await Future.delayed(
                    Duration(seconds: widget.macController.interval+2),
                  );
